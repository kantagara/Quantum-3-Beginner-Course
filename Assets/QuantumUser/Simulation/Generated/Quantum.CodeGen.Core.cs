...
namespace Quantum {
  ...
  public unsafe partial interface ISignalDamageableHit : ISignal {
    void DamageableHit(Frame f, EntityRef source, EntityRef victim, FP damage);
  }
  ...
  public unsafe partial class Frame {
    ...
    public unsafe partial struct FrameSignals {
      public void DamageableHit(EntityRef source, EntityRef victim, FP damage) {
        var array = _f._ISignalDamageableHitSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.DamageableHit(_f, source, victim, damage);
          }
        }
      }
